...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "插件清单", link: "/dev/plugin/manifest" },
      { text: "插件 server 模块", link: "/dev/plugin/server-api" },
      { text: "插件 JS 运行时", link: "/dev/plugin/runtime" },
      { text: "插件 RPC 接口", link: "/dev/plugin/rpc" },
      { text: "插件市场发布", link: "/dev/plugin/market" },
...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Plugin Manifest", link: "/en/dev/plugin/manifest" },
      { text: "Plugin server Module", link: "/en/dev/plugin/server-api" },
      { text: "Plugin JS Runtime", link: "/en/dev/plugin/runtime" },
      { text: "Plugin RPC Methods", link: "/en/dev/plugin/rpc" },
      { text: "Plugin Market", link: "/en/dev/plugin/market" },
